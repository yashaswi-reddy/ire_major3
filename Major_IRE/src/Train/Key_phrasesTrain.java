...
public class Key_phrasesTrain 
{
	   public static void main(String[] args) throws Exception
	   {
	      ...
	      while(i.hasNext()) 
	      {
	         ...
	         FileWriter fw = new FileWriter("/media/82CC3BADCC3B9A7D/major_project/IRData/entity_8/features/keyphrase_entities/subtopics"+fss+".txt", false);
