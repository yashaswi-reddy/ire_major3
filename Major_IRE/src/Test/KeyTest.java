...
public class KeyTest {
	...
	public KeyTest(String s,String s2)
	{
		dataFileName=s;	
		 linksFileName=s2;
	}
     ...
     for (Entry<String,String []> entry : test.entrySet())
       {
       	 ...
       	 FileWriter fw = new FileWriter("/media/82CC3BADCC3B9A7D/major_project/IRData/entity_8/test-features/keyphrases/"+key+".txt", false);
	...
	{
		KeyTest c = new KeyTest("/media/82CC3BADCC3B9A7D/major_project/IRData/Testing/tweet_text_modified/RL2013D01E008_texts.tsv","/media/82CC3BADCC3B9A7D/major_project/IRData/Testing/tweet_info/RL2013D01E008.dat");
		c.text();
	}
